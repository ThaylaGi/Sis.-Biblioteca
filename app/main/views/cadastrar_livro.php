...
<body class="min-h-screen bg-cover bg-center bg-no-repeat flex flex-col items-center p-4 sm:p-6 md:p-8 select-none"
    ...
    <div class="flex flex-col items-center w-full max-w-5xl mt-8 lg:mt-4">
        <img src="../assets/img/logo1.png"
            class="w-[150px] xs:w-[200px] sm:w-[250px] md:w-[300px] lg:w-[350px] mb-6 lg:mb-4" alt="Logo">

        <div class="w-full bg-white rounded-xl shadow-2xl overflow-hidden lg:mt-2">
            ...
            <form id="bookForm" action="../controllers/main_controller.php" method="post" class="p-4 sm:p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                        <h3 class="text-base font-semibold text-[#007A33] mb-3 border-b border-gray-200 pb-2 sticky top-0 bg-gray-50 z-10">
                        ...
                        <div class="space-y-3 max-h-[300px] overflow-y-auto pr-2">
                            ...
                            <div id="authorFields" class="space-y-2">
                                <div class="grid grid-cols-2 gap-3 author-row" data-index="1">
                                    <div class="relative group">
                                        <i class="fas fa-plus cursor-pointer text-[#007A33] hover:text-[#005F27] text-lg transition-colors duration-200 absolute left-2 top-1/2 transform -translate-y-1/2" id="addAuthor" title="Adicionar autor"></i>
                                        <i class="fas fa-user absolute left-8 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#007A33]"></i>
                                        <input type="text" id="nome1" name="nome[]"
                                            class="w-full pl-14 pr-3 py-2 bg-white border border-gray-300 rounded-lg focus:border-[#007A33] focus:ring-1 focus:ring-[#007A33]/20 focus:outline-none hover:border-gray-400 text-gray-600 placeholder-gray-400 transition-all duration-200"
                                            placeholder="Nome do Autor" required>
                                    </div>
                                    <div class="relative group ml-6">
                                        <i class="fas fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#007A33]"></i>
                            ...
                            <div class="relative group">
                                <i class="fas fa-bookmark absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#007A33]"></i>
                            ...
                            <div class="relative group">
                                <i class="fas fa-building absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#007A33]"></i>
                    ...
                    <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
                        <h3 class="text-base font-semibold text-[#007A33] mb-4 border-b border-gray-200 pb-2">
                            Localização e Estoque
                        </h3>
                        <div class="space-y-4">
                            <div class="relative group">
                                <i class="fas fa-calendar absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#007A33]"></i>
                            ...
                            <div class="relative group">
                                <i class="fas fa-route absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#007A33]"></i>
                            ...
                            <div class="relative group">
                                <i class="fas fa-hashtag absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#007A33]"></i>
                            ...
                            <div class="relative group">
                                <i class="fas fa-layer-group absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-[#007A33]"></i>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Função para habilitar/desabilitar o botão de adicionar
            function toggleAddButton() {
                if (authorCount >= maxAuthors) {
                    addAuthorBtn.classList.add('opacity-50', 'cursor-not-allowed');
                    addAuthorBtn.removeEventListener('click', addAuthor);
                } else {
                    addAuthorBtn.classList.remove('opacity-50', 'cursor-not-allowed');
